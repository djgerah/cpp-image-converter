...
/*
    ...
    Этот код указывается в начале файла. После него идут ширина и высота изображения, записанные обычными числами в
   текстовом виде. Заканчивается заголовок максимальным значением цвета. Это число, которое в рассматриваемых примерах
   будет всегда равно 255.
*/
